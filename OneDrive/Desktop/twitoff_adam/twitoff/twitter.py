...
def add_or_update_user(username):
    ...
    try:
        ...
        # if we don't already have that user we'll create a new one
        ...
        # this won't re-add a user if they've been already added
        DB.session.add(db_user)

        # get the users tweets (in a list)
...
# give the fucntion some text, it returns a word embedding
